...
CORS_ALLOWED_ORIGINS= config('DJANGO_CORS_HOSTS', default='http://localhost:3000').split(',')
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Collected static files will be placed here
